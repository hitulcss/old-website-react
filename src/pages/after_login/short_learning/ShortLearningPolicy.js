...
import "./ShortLearningPolicy.css";
const style = {
  position: "absolute",
  top: "50%",
  left: "50%",
...
const ShortLearningPolicy = ({ shortLearningPolicy, setShortLearningPrivacyPolicy }) => {
  const handleOpen = () => setShortLearningPrivacyPolicy(true);
  const handleClose = () => setShortLearningPrivacyPolicy(false);
...
export default ShortLearningPolicy;
