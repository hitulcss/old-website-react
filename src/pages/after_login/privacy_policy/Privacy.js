      ...
      <div>
        ...
        >
          <div
            ...
            style={{ padding: "2rem", marginTop: "0rem" }}
          >
            <div className="privacy_policy_wrapper">
              <div className="privacy_policy_header">
                ...
                <div className="definition">
                  ...
                  <p>
                    <span>Personal</span> Data is any information that relates
                ...
                <div className="personal_data">
                  ...
                  <h4> Personal Data</h4>
                  <p>
                    We collect certain information about You to help us serve
                    You better. The information collected by Us is of the
                    following nature:
                  </p>
                  <p>
                    <ul>
                      ...
                      <li>
                        Other information about the service address which You
                        give Us
                      </li>
                      <li>Information about your device</li>
                      <li>Network information</li>
                      <li>User uploaded photo</li>
                      <li>
                        Demographic information such as postcode, preferences
                        and interests
                      </li>
                      <li>
                        Any other personal information which you give us in
                        connection while booking a service or is relevant to
                ...
                <div className="dnd">
                  ...
                  <p>
                    ...
                    sdcampus.com you authorize us to contact you via email or
                    phone call or sms and offer you our services, imparting
                    ...
                    be collected. And irrespective of the fact if you have also
                    registered yourself under DND or DNC or NCPR service, you
                    still authorize us to give you a call from sdcampus.com for
                    the above mentioned purposes till 365 days of your
                ...
                <div className="refund_policy">
                  <h2>Refund Policy</h2>
                  <p>
                    At SD Campus, we want our customers to be fully satisfied
                    with their purchases. However, we do have a no refund policy
                    for most products and services.
                  </p>

                  <p>
                    <strong>Online Batches and Other Services</strong>
                  </p>
                  <p>
                    {" "}
                    All online batches, coaching services, and other intangible
                    products are non-refundable after purchase. We do not
                    provide refunds on these services.
                  </p>
                  <p>
                  ...
                  <p>
                    {" "}
                    Physical products like books and accessories are eligible
                    for refund or replacement only if:
                  </p>
                  <ul>
                    <li>
                      The item received is damaged or defective. A replacement
                      will be provided.
                    </li>
                    <li>
                      The item is lost by the courier partner during transit. A
                      replacement or refund will be provided.
                    </li>
                    <li>
                      {" "}
                      If you receive a wrong or damaged product, please contact
                      our customer support team within 7 days along with order
                      details and images. We will evaluate and provide a
                      resolution.
                    </li>
                  </ul>
                  <p>
                    <strong>Incorrect Purchases</strong>
                  </p>
                  <p>
                    {" "}
                    If you purchase a product or batch by mistake, you can
                    request to change it to another batch or product of the same
                    value. This change request must be made within 10 days of
                  ...
                  <p>
                    {" "}
                    We do not provide refunds if you change your mind or wish to
                    cancel an order after purchase. Please review products
                    carefully before ordering.
                  </p>
                  <p>
                    We hope this refund policy provides clarity to our
                    customers. Please reach out with any other questions. We aim
                    to resolve any issues to your satisfaction.
                  </p>
                </div>
                ...
                <div className="contact_us">
                  ...
                  <p>
                    By email:{" "}
                    <a href="mailto:contact@sdempire.co.in">
                      contact@sdempire.co.in
                    </a>
                  </p>
                  <p>
